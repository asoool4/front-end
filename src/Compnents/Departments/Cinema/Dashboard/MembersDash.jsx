...
export default function MembersDash() {
    ...
    useEffect(() => {
        ...
        if (localStorage.getItem("OurCinemaMembers") === null) {
            localStorage.setItem("OurCinemaMembers", JSON.stringify([]));
            setMembersContainer([]);
        } else {
            setMembersContainer(JSON.parse(localStorage.getItem("OurCinemaMembers")));
        }
    }, []);
    ...
    const AddMember = () => {
        ...
        reader.onload = () => {
            ...
            localStorage.setItem("OurCinemaMembers", JSON.stringify(updatedMembers));
            resetInput();
        };
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col ">
                                ...
                                <div className="btns">
                                    <button className="btn btn-success mt-3" onClick={AddMember}>Add Member</button>
