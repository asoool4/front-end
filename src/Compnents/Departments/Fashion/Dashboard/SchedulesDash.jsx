...
export default function SchedulesDash() {
    ...
    useEffect(() => {
        const storedSchedules = JSON.parse(localStorage.getItem("ourScheduales"));
        if (storedSchedules) {
    ...
    function AddResearch() {
        ...
        localStorage.setItem("ourScheduales", JSON.stringify([...schedualesContainer, newResearch]));
    ...
    function deleteAll() {
        ...
        localStorage.removeItem("ourScheduales");
    }
    ...
    function deleteSchedule(index) {
        ...
        localStorage.setItem("ourScheduales", JSON.stringify(updatedSchedules));
    }
