...
import styles from './MembersHomeDashh.module.css';

export default function MembersHomeDashh() {
    ...
    const AddMember = () => {
        ...
        reader.onload = () => {
            ...
            localStorage.setItem("ourFashionMembersAtHome", JSON.stringify(updatedMembers));
            resetInput();
        };
