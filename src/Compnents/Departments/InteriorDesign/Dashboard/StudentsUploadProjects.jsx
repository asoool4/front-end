...
export default function StudentsUploadProjects() {
    ...
    useEffect(() => {
        const storedProjects = JSON.parse(localStorage.getItem("ourIDStudentsProject"));
        if (storedProjects) {
    ...
    const addProject = () => {
        ...
        reader.onload = function (e) {
            ...
            localStorage.setItem("ourIDStudentsProject", JSON.stringify(updatedProjects));
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourIDStudentsProject");
        setProjectContainer([]);
    };
