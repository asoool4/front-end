...
export default function UploadResearches() {
    ...
    useEffect(() => {
        if (localStorage.getItem("ourPDResearch") === null) {
            setResearchContainer([]);
        } else {
            setResearchContainer(JSON.parse(localStorage.getItem("ourPDResearch")));
        }
    }, []);
    ...
    const AddResearch = () => {
        ...
        reader.onload = function (e) {
            ...
            localStorage.setItem("ourPDResearch", JSON.stringify(updatedResearchContainer));
            deleteInput();
        };
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourPDResearch");
        setResearchContainer([]);
    };
