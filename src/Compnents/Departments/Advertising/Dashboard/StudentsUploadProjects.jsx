...
function handelChange(e) {
    ...
    useEffect(() => {
        const storedProjects = JSON.parse(localStorage.getItem("ourADVStudentsProject"));
        if (storedProjects) {
    ...
    const addProject = () => {
        ...
        reader.onload = function (e) {
            ...
            localStorage.setItem("ourADVStudentsProject", JSON.stringify(updatedProjects));
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourADVStudentsProject");
        setProjectContainer([]);
    };
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col">
                                ...
                                <input name='imageCover'  onChange={handelChange} type="file"  className={`${styles.formControl} form-control mt-1 `} id="ProductImage" />
                                ...
                                <div className="btns py-4">
                                    <button className="btn btn-success mt-3"  type='submit' onClick={addProject}>Add Project</button>
                                </div>
                                </form>
                            </div>
                        </div>
