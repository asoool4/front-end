...
export default function UploadResearches() {
    ...
    useEffect(() => {
        if (localStorage.getItem("ourCinemaResearch") === null) {
            setResearchContainer([]);
        } else {
            setResearchContainer(JSON.parse(localStorage.getItem("ourCinemaResearch")));
        }
    }, []);
    ...
    const AddResearch = () => {
        ...
        reader.onload = function (e) {
            ...
            localStorage.setItem("ourCinemaResearch", JSON.stringify(updatedResearchContainer));
            deleteInput();
        };
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourCinemaResearch");
        setResearchContainer([]);
    };
