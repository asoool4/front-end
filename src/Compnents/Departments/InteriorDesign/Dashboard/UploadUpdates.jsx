...
export default function UploadResearches() {
    ...
    useEffect(() => {
        if (localStorage.getItem("ourIDResearch") === null) {
            setResearchContainer([]);
        } else {
            setResearchContainer(JSON.parse(localStorage.getItem("ourIDResearch")));
        }
    }, []);
    ...
    const AddResearch = () => {
        ...
        reader.onload = function (e) {
            ...
            localStorage.setItem("ourIDResearch", JSON.stringify(updatedResearchContainer));
            deleteInput();
        };
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourIDResearch");
        setResearchContainer([]);
    };
