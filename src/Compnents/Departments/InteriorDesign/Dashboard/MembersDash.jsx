...
export default function MembersDash() {
    ...
    useEffect(() => {
        if (localStorage.getItem("OurIDMembers") === null) {
            localStorage.setItem("OurIDMembers", JSON.stringify([]));
            setMembersContainer([]);
        } else {
            setMembersContainer(JSON.parse(localStorage.getItem("OurIDMembers")));
        }
    }, []);
    ...
    const AddMember = () => {
        ...
        reader.onload = () => {
            ...
            localStorage.setItem("OurIDMembers", JSON.stringify(updatedMembers));
            resetInput();
        };
