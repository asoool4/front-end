...
setData(result)
    ...
    useEffect(() => {
        const storedProjects = JSON.parse(localStorage.getItem("ourADVProject"));
        if (storedProjects) {
    ...
    const addProject = () => {
        ...
        reader.onload = function (e) {
            ...
            localStorage.setItem("ourADVProject", JSON.stringify(updatedProjects));
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourADVProject");
        setProjectContainer([]);
    };
