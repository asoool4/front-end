...
export default function SubjectDash() {
    ...
    useEffect(() => {
        const storedSubjects = localStorage.getItem("ourFashionSubjects");
        if (storedSubjects) {
    ...
    const addResearch = () => {
        ...
        localStorage.setItem("ourFashionSubjects", JSON.stringify(updatedSubjects));
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourFashionSubjects");
        setSubjectContainer([]);
    };
