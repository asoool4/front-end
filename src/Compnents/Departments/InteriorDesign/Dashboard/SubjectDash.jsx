...
export default function SubjectDash() {
    ...
    useEffect(() => {
        const storedSubjects = localStorage.getItem("ourIDSubjects");
        if (storedSubjects) {
    ...
    const addResearch = () => {
        ...
        localStorage.setItem("ourIDSubjects", JSON.stringify(updatedSubjects));
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourIDSubjects");
        setSubjectContainer([]);
    };
