...
export default function MembersDash() {
    ...
    useEffect(() => {
        if (localStorage.getItem("OurADVMembers") === null) {
            localStorage.setItem("OurADVMembers", JSON.stringify([]));
            setMembersContainer([]);
        } else {
            setMembersContainer(JSON.parse(localStorage.getItem("OurADVMembers")));
        }
    }, []);
    ...
    const AddMember = () => {
        ...
        reader.onload = () => {
            ...
            localStorage.setItem("OurADVMembers", JSON.stringify(updatedMembers));
            resetInput();
        };
