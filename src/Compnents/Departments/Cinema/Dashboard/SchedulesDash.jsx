...
export default function SchedulesDash() {
    ...
    function AddResearch() {
        ...
        localStorage.setItem("ourCinemaScheduales", JSON.stringify([...schedualesContainer, newResearch]));
    ...
    function deleteAll() {
        ...
        localStorage.removeItem("ourCinemaScheduales");
    }
    ...
    function deleteSchedule(index) {
        ...
        localStorage.setItem("ourCinemaScheduales", JSON.stringify(updatedSchedules));
    }
