...
export default function UploadPhotosDash() {
    ...
    useEffect(() => {
        const storedProjects = JSON.parse(localStorage.getItem("ourCinemaProject"));
        if (storedProjects) {
    ...
    const addProject = () => {
        ...
        reader.onload = function (e) {
            ...
            localStorage.setItem("ourCinemaProject", JSON.stringify(updatedProjects));
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourCinemaProject");
        setProjectContainer([]);
    };
                        ...
                        <div className="row">
                            <div className="col">
                                <div className={styles.Requests}>
                                    <Link to="/Cinema/UploadProjects/CinemaRequestViewer">
