...
export default function SchedulesDash() {
    ...
    useEffect(() => {
        const storedSchedules = JSON.parse(localStorage.getItem("ourADVScheduales"));
        if (storedSchedules) {
    ...
    function AddResearch() {
        ...
        localStorage.setItem("ourADVScheduales", JSON.stringify([...schedualesContainer, newResearch]));
    ...
    function deleteAll() {
        ...
        localStorage.removeItem("ourADVScheduales");
    }
    ...
    function deleteSchedule(index) {
        ...
        localStorage.setItem("ourADVScheduales", JSON.stringify(updatedSchedules));
    }
