...
export default function SchedulesDash() {
    ...
    useEffect(() => {
        const storedSchedules = JSON.parse(localStorage.getItem("ourIDScheduales"));
        if (storedSchedules) {
    ...
    function AddResearch() {
        ...
        localStorage.setItem("ourIDScheduales", JSON.stringify([...schedualesContainer, newResearch]));
    ...
    function deleteAll() {
        ...
        localStorage.removeItem("ourIDScheduales");
    }
    ...
    function deleteSchedule(index) {
        ...
        localStorage.setItem("ourIDScheduales", JSON.stringify(updatedSchedules));
    }
