...
export default function SubjectDash() {
    ...
    useEffect(() => {
        const storedSubjects = localStorage.getItem("ourCinemaSubjects");
        if (storedSubjects) {
    ...
    const addResearch = () => {
        ...
        localStorage.setItem("ourCinemaSubjects", JSON.stringify(updatedSubjects));
    ...
    const deleteAll = () => {
        localStorage.removeItem("ourCinemaSubjects");
        setSubjectContainer([]);
    };
